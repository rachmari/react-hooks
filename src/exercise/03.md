...
⚡ Always remember to push state back down when refactoring a component.

### What is prop drilling?

Prop drilling (also called "threading") refers to the process you have to go through to get data to parts of the React Component tree. For example, component parent accepts props that it doesn't use directory, but its children need.
...
Fill out
[the feedback form](https://ws.kcd.im/?ws=React%20Hooks%20%F0%9F%8E%A3&e=03%3A%20Lifting%20state&em=s.rachael%40gmail.com).
